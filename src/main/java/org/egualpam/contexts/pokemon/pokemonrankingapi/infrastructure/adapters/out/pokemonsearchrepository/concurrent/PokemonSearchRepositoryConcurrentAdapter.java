package org.egualpam.contexts.pokemon.pokemonrankingapi.infrastructure.adapters.out.pokemonsearchrepository.concurrent;
...
public final class PokemonSearchRepositoryConcurrentAdapter implements PokemonSearchRepository {
    ...
    public PokemonSearchRepositoryConcurrentAdapter(PokeApiClientProperties pokeApiClientProperties) {
        this.pokemonsSupplier = new ConcurrentPokemonsSupplier(pokeApiClientProperties);
    }
